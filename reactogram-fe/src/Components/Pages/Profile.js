    ...
    <div className='container shadow mt-3 p-4'>
      <div className='row'>
        <div className='col-md-6 d-flex flex-column'>
          <img className='p-2 profile-pic img-fluid' alt="profile pic" src="https://images.unsplash.com/photo-1621012430307-b4774b78d3cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lybCUyMGFsb25lfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"  />
                ...
                <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="true">
                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <img className="postDetailImgCtrl" src={postDetail.image} alt="..." />
                    </div>
                ...
                <div className='col-6 d-flex'>
                  ...
                  <div className="dropdown ms-5">
                    <a className="btn" href="#" role="button" data-bs-toggle="dropdown">
                      ...
                      <i className=" ellipsisCtrl1 fa-solid fa-ellipsis"></i>
                    </a>
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        <a style={{cursor: "pointer"}} className="dropdown-item" onClick={() => deletePost(postDetail._id)}>
