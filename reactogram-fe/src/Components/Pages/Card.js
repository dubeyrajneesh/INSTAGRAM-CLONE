                ...
                <div className="card-body px-2">
                    <div className='row'>
                        <div className='col-6 d-flex'>
                            <img className='p-2 post-profile-pic' alt="profile pic" src="https://images.unsplash.com/photo-1621012430307-b4774b78d3cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lybCUyMGFsb25lfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60" />
                            <div className='mt-2'>
                        ...
                        {/* {props.postData.author._id == user.user._id ? <div className='col-6'>
                            <img  onClick={() => props.deletePost(props.postData._id)} style={{ cursor: "pointer" }} className=' moreActionFix float-end fs-3 p-2 mt-2' alt="more action" src={moreAction} />
                        </div> : ""} */}

                        {props.postData.author._id == user.user._id ? <div className='col-6'>
                            {/* <img onClick={() => props.deletePost(props.postData._id)} style={{ cursor: "pointer" }} className=' moreActionFix float-end fs-3 p-2 mt-2' alt="more action" src={moreAction} /> */}

                            <i onClick={() => props.deletePost(props.postData._id)} style={{ cursor: "pointer" }}  className="VerticalCtrl fa-solid fa-ellipsis-vertical"></i>
                        </div> : ""}
                    </div>
                    <div className='row'>
