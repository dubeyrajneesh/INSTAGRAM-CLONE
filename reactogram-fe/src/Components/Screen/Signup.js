      ...
      <div className="container login-container">
          <div className="row">
              <div className="col-md-7 col-sm-12 d-flex justify-content-center align-items-center">
                  <img alt="social" className='desktop_image' style={{ height: '85%' }} src={desktop_image} />
                  {/* <img alt="social" className='mobile_image' src={mobile_image} /> */}
              </div>
                          ...
                          <form onSubmit={(e) => signup(e)}>
                              ...
                              <div className='mt-3 mb-5 d-grid'>
                                  <button className="custom-btn custom-btn-white">
                                      ...
                                      <NavLink to="/login" className='ms-1 text-info fw-bold'>Log In</NavLink>
                                  </button>
                              </div>
                          </form>
                      </div>
